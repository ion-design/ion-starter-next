...
If brand guidelines include a reference website URL:
1. Take a screenshot of the reference website for visual comparison
2. Compare the generated design's visual alignment — colors, typography, spacing, overall vibe
3. Note specific deviations from the reference site's aesthetic
4. Prioritize fixes that bring the design closer to the reference site's feel

This screenshot comparison ensures brand adherence goes beyond token matching to actual visual coherence.
...
1. **Discover the design system**: Search for design system documentation, UI guidelines, component libraries, or style guides (grep for "design system", "ui guide", "style guide", etc.). Study it thoroughly until you understand:
   ...
   **CRITICAL**: If something isn't clear, infer from the existing codebase and brand guidelines. Use your best judgment — don't block on ambiguity.
