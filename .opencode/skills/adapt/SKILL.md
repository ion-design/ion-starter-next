...
Invoke /frontend-design — it contains design principles, anti-patterns, and brand context guidance. Load the brand-guidelines skill if brand context is available in company-docs/brand-guidelines.md. Additionally gather: target platforms/devices and usage contexts.
