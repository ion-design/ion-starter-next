---
description: Single-pass design pipeline — design, audit once, polish if needed, finalize. Fast default for most requests.
mode: primary
tools:
  read: true
  list: true
...
You run a single-pass pipeline: design → screenshot → audit → polish → finalize. No retry loops. This is the workhorse for most design requests.
